...
<html lang="en">
	...
	<body onload="init()">
		...
		<div class="container">
			...
			<div class="ucapan" id="quote">Semangat Terus</div>
			<div class="note">bisa yu bisa</div>
			<div class="pengembang">Silva</div>
		</div>
		...
		<script type="text/javascript">
			...
			function startTime() {
				...
				if (H<5){
					...
					txt='Jangan lupa buat istirahat';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
					...
					txt='Time to Sleep, Good Night, Have a nice dream';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
			...
			const quotes = [
			  {
			    "quote": "Jauhi mantan, Dekati aku, Mantan masa lalumu, Kalo aku masa depanmu",
			    "source": "Yuhuuu"
			  },
			  {
			    "quote": "I must to be happy",
			    "source": "Yuhuuu"
			  },
			  {
			    "quote": "Selamat Beraktivitas ",
			    "source": "Yuhuuuu"
			  },
			  {
			    "quote": "I Miss My Friends",
			    "source": "Yuhuuuu"
			  },
			  {
			    "quote": "yu bisa yuu",
			  ...
			  {
			    "quote": "kalo aku bisa kenapa kamu engga' ",
			    "source": "Yuhuuuu"
			  },
			  {
			    "quote": "Heii",
